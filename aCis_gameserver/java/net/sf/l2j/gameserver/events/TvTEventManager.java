...
public class TvTEventManager
{
	...
	class TvTStartTask implements Runnable
	{
		...
		public void run()
		{
			...
			else
			{
				...
				{
					TvTEventManager.this.startReg();
				}
				else if (TvTEvent.isParticipating())
				{
					TvTEventManager.this.startEvent();
				}
				else
				{
					TvTEventManager.this.endEvent();
				}
			}
	...
	{
		protected static final TvTEventManager _instance = new TvTEventManager();
	}
}